...
module WidgetUtil {
    ...
    function _drawHeader(dc, height, color, strokeColor, text, textColor) {
        ...
        if (text != null && !text.equals("")) {
            ...
            dc.drawText(dc.getWidth() / 2, height / 2,
                Graphene.FONT_TINY, text, Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
        }
    }
    ...
    function _drawFooter(dc, height, color, strokeColor, text, textColor) {
        ...
        if (text != null && !text.equals("")) {
            dc.setColor(textColor, color);
            dc.drawText(dc.getWidth() / 2, dc.getHeight() - height / 2,
                Graphene.FONT_TINY, text, Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
        }
    }
