...
module AppColors {
    ...
    const GROUP_BUS_EXPRESS_EXPRESS = Graphene.COLOR_LT_RED;
    ...
    const GROUP_TRAIN_EXPRESS_EXPRESS = Graphene.COLOR_LIME;
    const GROUP_TRAIN_EXPRESS_SNABBTAG = Graphene.COLOR_AMBER;
